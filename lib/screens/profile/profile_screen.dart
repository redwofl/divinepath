        ...
        children: [
          ...
          if (_loading)
            ...
            SwitchListTile(
              ...
              subtitle: Text(
                Translations.get('toggle_dark_theme', locale: locCode),
                style: TextStyle(
                  color: isDark ? AppColors.textLight : AppColors.textSecondary,
                ),
              ),
            ...
            SwitchListTile(
              ...
              subtitle: Text(
                Translations.get('daily_reminders', locale: locCode),
                style: TextStyle(
                  color: isDark ? AppColors.textLight : AppColors.textSecondary,
                ),
              ),
            ...
            SwitchListTile(
              title: Text(
                Translations.get('haptic_feedback', locale: locCode),
                style: TextStyle(
                  color: isDark ? AppColors.textOnDark : AppColors.textPrimary,
                ),
              ),
              subtitle: Text(
                Translations.get('vibration_on_chant', locale: locCode),
                style: TextStyle(
                  color: isDark ? AppColors.textLight : AppColors.textSecondary,
                ),
              ),
